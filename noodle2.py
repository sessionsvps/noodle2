...
async def logUserBot():
    load_dotenv()
    api_id = int(26911879)
    api_hash = "3ab165a775081849b8c304e8e96c1c46"
    phone_number = "51987451167"
                ...
                if i['group_name'] not in ["Spam 2024"]:
                    ...
                    for message_spam in messages_list:
                        ...
                        try:
                            ...
                            await client.send_message("@Coronadobi", f'<b>Error enviando mensajes a  a {i["group_id"]}</b> - <code>{i["group_name"]}<code>\nCausa:{error}',parse_mode="HTML")
                            resultado = False
                        if resultado:
